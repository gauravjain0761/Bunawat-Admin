...
function EnhancedTableHead(props) {
    ...
    return (
        <TableHead>
            <TableRow >
                <TableCell sx={{ width: { lg: 20, xs: 40 }, backgroundColor: UIColor }}>
                    {/* <DragHandle /> */}
                </TableCell>
                {!disableCheckBox &&
...
const DragTableComponent = (props) => {
    let { rows, columns, selected, renderRow, page, totalCount, rowsPerPage, handleChangeRowsPerPage, handleChangePage, handleSelectAllClick, disableCheckBox, disableColumns, extraDisable, disablePagination, extraPaddingOnFirstColumn, onSortEnd, isLoading } = props;
                        ...
                        <TableBodySortable onSortEnd={onSortEnd} useDragHandle>
                            {isLoading ?
                                ...
                                <>
                                    {rows.length > 0 ?
                                        <>
                                            {stableSort(rows, getComparator(order, orderBy)).map(renderRow)}
                                        </>
                                        :
                                        <TableRow>
                                            <TableCell align='center' sx={{
...
export default DragTableComponent
